...
@Component({
  selector: 'zd-base-cap-sctr-pension',
  templateUrl: './base_cap_sctr_pension.component.html',
  styleUrls: ['./base_cap_sctr_pension.component.css'],  
  encapsulation: ViewEncapsulation.None,
})
export class BaseCapSctrPensionComponent implements OnInit {
 ...
 rowData:any={};
  ...
  getMetas(){
    this.baseCapService.getMetas('2022').subscribe( (data) => {
  ...
  cargarPap():Promise<any>{    
    return this.httpClient.get("http://rrhh.pvn.gob.pe/api/cap/base_cap").toPromise()
      .then(result => {        
        console.log(result);        
