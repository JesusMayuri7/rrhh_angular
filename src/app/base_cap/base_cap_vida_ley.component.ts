...
@Component({
  selector: 'zd-base-cap-vida-ley',
  templateUrl: './base_cap_vida_ley.component.html',
  styleUrls: ['./base_cap_vida_ley.component.css'],  
  encapsulation: ViewEncapsulation.None,
})
export class BaseCapVidaLeyComponent implements OnInit {
