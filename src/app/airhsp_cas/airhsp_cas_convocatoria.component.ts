...
@Component({
    selector: 'zd-airhsp_cas-convocatoria',
    templateUrl: './airhsp_cas_convocatoria.component.html',
    styleUrls: ['./airhsp_cas_convocatoria.component.css'],
    encapsulation: ViewEncapsulation.None,
    providers: [MessageService]
})

export class AirhspCasConvocatoriaComponent implements OnInit{
    form:FormGroup;
    submitted = false;
    loading = false;
    escalas:any[];
