...
@Component({
  selector: 'zd-planilla-formativa',  
  templateUrl: './planilla_formativa.component.html',
  styleUrls: ['./planilla_formativa.component.css'],
  encapsulation: ViewEncapsulation.None,
  providers:[PlanillaFormativaService,ExcelService,MessageService,DialogService],

})
export class PlanillaFormativaComponent implements OnInit,OnDestroy {
  vigencias:any[];
  meses:any[];
  mes:number=0;
    ...
    }, 
 {
    ...
    store: new CustomStore({
      load: function(loadOptions) {        
        return a.httpClient.get("http://rrhh.pvn.gob.pe/api/formativa/planilla/planilla_formativa",
        {headers :header})
        .toPromise()
        .then(result => {              
          return {          
