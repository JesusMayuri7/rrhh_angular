  ...
  ngOnInit() {
    ...
    this.cols = [   
      { field: 'nroCap', header: 'N° Cap' ,ancho:'2.0em',estilo: {'font-size':'0.6em'},rowspan:'1',visible:true,numero:false},      
        ...
        { field: 'nro_documento', header: 'N° Doc.', ancho:'3.5em',estilo: { 'font-size':'0.6em'},rowspan:'1',visible:true,numero:false},
        { field: 'fecha_documento', header: 'Fecha Doc.',ancho:'3.5em',estilo: {'font-size':'0.6em'},rowspan:'1',visible:true,numero:false },        
        { field: 'fin', header: 'Fin',ancho:'5.0em',estilo: {'font-size':'0.6em'},rowspan:'1',visible:true,numero:false },        
        { field: 'nro_documento_fin', header: 'N° Doc.', ancho:'3.5em',estilo: { 'font-size':'0.6em'},rowspan:'1',visible:true,numero:false},
        { field: 'fecha_documento_fin', header: 'Fecha Doc.',ancho:'3.5em',estilo: {'font-size':'0.6em'},rowspan:'1',visible:true,numero:false },        
